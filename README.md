# Shell Navigation And Selection - ניוון בין מסכים  -MAUI

פרויקט זה משמש כבסיס לימודי להדגמת מימוש ארכיטקטורת MVVM ושילוב של הזרקת תלות (DependencY Injection) באפליקציית .NET MAUI. הפרויקט כולל דוגמה מעשית לניהול ציוני שחקנים ותצוגתם ניווט בין מסכים. 
